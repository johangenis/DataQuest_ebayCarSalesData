...
#### Column will be changed from camelcase to snakecase and some will be reworded based on the data dictionary to be more descriptive.
...
#### Exploring the data to find obvious areas to clean the data.
